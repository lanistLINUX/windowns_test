...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12   col-sm-5  top-picture" id="pics">
                ...
                <div class="p1 hidden-sm hidden-xs">
                        <img src="../img/ChidalVeil/four_1.png" class="sampleimage img-responsive" id="i1">
                </div>
    ...
    <!--</span></div>-->
            ...
            <div class="col-sm-4 hidden-xs top-dec">
                ...
                <p >设计师：<span id="author">蔡美月</span></p>

                <p id="information">说明: 图片仅供参考，具体面料、花色请咨询门店</p>
 <div  ><p> <a href="Reservation.jsp" id="add">预约试衣</a></p></div>
              	
              <div  ><p> <a href="server_online.jsp" target="_blank">点击咨询</a></p></div>
           <!--     <div id="yuyue" ><p> <a href="Reservation.jsp"    target="_blank">预约试衣</a></p></div>   	
              <div  id="consult" ><p> <a  href="server_online.jsp" target="_blank">点击咨询</a></p></div> -->
            </div>
	   ...
	   $.ajax({
			...
			success:function(data){
		  	 ...
		  	 var address = 	JSON.parse(data); 
				$("#add").attr("href","Reservation.jsp?name="+address[0].dress_name+"");
		  	 $("#i1").attr("src",address[0].url);
		  	 $("#title").html(address[0].dress_name);
		  		$("#author").html(address[0].author_name); 
