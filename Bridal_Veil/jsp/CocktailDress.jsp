    ...
    <div class="container" id="mama"> <!--顶部四图-->
        ...
        <div class="split row">
            <div class="col-xs-12 col-sm-3" style="text-align: center;">
                <select name="kind" id="" onchange=mbar(this)>
                    <option value="fenlei">人气推荐</option>
                    <option value="gexin" onclick="">个性款</option>
                    <option value="qizhi">气质款</option>
                    <option value="shishang">时尚款</option>
                </select>
            </div>
        </div>
        
        <!-- ------------------- -->
        <span id="pick" class="container bigger">
    ...
    <!-- ------------------------------- -->    
        ...
        <div class="container ">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 middle-picture">
                    <div class="courseBefore  ">
                        <a href="CocktailDress_Detail.jsp" target="_blank"><img src="../imgk_dh_18.png " class="img-responsive liu-1"></a>
                    </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 middle-picture">
                    <div class="courseBefore ">
                        <a href="CocktailDress_Detail.jsp" target="_blank"><img src="../imgk_dh_19.png" class="img-responsive liu-2"></a>
                    </div>
                    <div class="courseAfter ">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12 middle-picture">
                    <div class="courseBefore ">
                        <a href="CocktailDress_Detail.jsp" target="_blank"><img src="../imgk_dh_20.png" class="img-responsive liu-3"></a>
                    </div>
                    <div class="courseAfter ">
    ...
    function mbar(obj){
    	   ...
    	   $.ajax({
    			...
    			for(var i=0;i<addres.length;i++){
    				 ...
    				 $("#pick").append(" <div class=\"col-sm-4 col-xs-12 little-picture\"> "
    		    	         +"  <a href=\"CocktailDress_Detail.jsp?name="+addres[i].dress_name+"&url="+addres[i].url+"&author="+addres[i].author_name+"\" target=\"_blank\"><img src=\""+addres[i].url+"\" class=\"img-responsive\"></a> "
    		    	     +"   </div>");
