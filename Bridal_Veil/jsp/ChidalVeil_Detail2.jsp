...
<head lang="zh-cn">
    ...
    <link rel="stylesheet" href="../css/ChidalVeil_Detail2.css"/>
...
<div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12   col-sm-5  top-picture" id="pics">
                <div class="p1"><img src="../img/ChidalVeil/xq2_1_1.jpg" class="img-responsive" id="i1">
    ...
    <br><br>   设计师：蔡美月<br>
            ...
            　　　　　　
            <!--大界面下的文字-->
            <div class="col-sm-4 hidden-xs top_dec">
                <p id="title">中国风长款秀禾服</p>
            ...
            <div class="visible-xs row">
                ...
                <div id="zixun1" class="col-xs-3 consult"><p>点击咨询</p></div>
            </div>
        ...
        <!--四张小图-->
        <div class="hidden-xs row " id="li_img">
            <div class="col-sm-1 four_img"
                 onclick="change_img1()"><img class="" src="../img/ChidalVeil/xq2_li_1.png"></div>
            <div class="col-sm-1 four_img"
                 onclick="change_img2()"><img class="" src="../img/ChidalVeil/xq2_li_2.png"></div>
           <div class="col-sm-1 four_img"
                 onclick="change_img3()"><img class="" src="../img/ChidalVeil/xq2_li_3.png"></div>
            <div class="col-sm-1 four_img"
                 onclick="change_img4()"><img class="" src="../img/ChidalVeil/xq2_li_4.png"></div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/xq2_1.png" alt="" class="img-responsive"/>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/xq2_2.png" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/shougao_1.png" alt="" class="img-responsive img_shouhui_1"/>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="text3">
                    手绘设计稿
                ...
                <div class="text_yc_1">
                    倚重造型设计，其华贵源于云肩、袖口及腰部。<br>将大量刺绣工艺打磨在云肩上，映出贵丽之感。
                    <br>开放式袖口与褂摆的刺绣相连，衔接成一片花海。
                    <br>腰部收身设计，提升女性的典雅气质。
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="text_yc_2 hidden-sm hidden-xs">
                    刺绣花手稿
                </div>
                <div class="text_yc_3 hidden-sm hidden-xs">
                    精湛的刺绣工艺，丝丝缭绕，纹理清新明快。<br>造型复杂多变，看似简单，做工及其复杂。
                    <br>多种不同材质丝线缝制而成，各种花型尽显立体饱满，栩栩如生。
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/shougao_2.png" alt="" class="img-responsive img_shouhui_2"/>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="text3 visible-sm visible-xs">
                    刺绣花手稿
                </div>
                <div class="text_yc_1 visible-sm visible-xs">
                    精湛的刺绣工艺，丝丝缭绕，纹理清新明快。<br>造型复杂多变，看似简单，做工及其复杂。
                    <br>多种不同材质丝线缝制而成，各种花型尽显立体饱满，栩栩如生。
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/xijie_1.png" alt="" class="img-responsive img1"/>
            </div>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/xijie_2.png" alt="" class="img-responsive img1"/>
            </div>
            <div class="col-md-7 col-sm-12 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12 col-xs-12">
                <img src="../img/ChidalVeil/xijie_3.png" alt="" class="img-responsive img1"/>
            </div>
            <div class="col-md-7 col-sm-12 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-sx-12">
                <img src="../img/ChidalVeil/shipai_1.jpg" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-sx-12">
                <img src="../img/ChidalVeil/shipai_2.png" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-sx-12">
                <img src="../img/ChidalVeil/shipai_3.png" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-sx-12">
                <img src="../img/ChidalVeil/shipai_4.png" alt="" class="img-responsive"/>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-sx-12">
                <img src="../img/ChidalVeil/shipai_5.jpg" alt="" class="img-responsive"/>
            </div>
        </div>
    </div>
