...
<body>
    <div class="container">
        <div class="content">
            ...
            <div class="con_cen">
             <div class="shou">
                    <input class="fp_phone" id="ypwd"  type="password" name="fp_pwd" value="" placeholder="原始密码">
                </div>
                <div class="shou">
                    <input class="fp_phone" id="npwd1" type="password" name="password" value="" placeholder="输入新密码">
                </div>
                <div class="mess_inv">
                    <input class="fp_phone"  id="qpwd1" type="password"  placeholder="确认新密码" />
                </div>
    ...
    function pass(){
    	...
    	if(npwd!=qpwd||kong==0){
    		...
    		$.ajax({
				...
				async:true,
				url:"../updataPwdServlet",
				type:"post",
				data:{ypwd:ypwd,pwd:npwd},
