    ...
    <div class="container div1" >
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="row">
                    <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><div class="hi" style="position: relative">
...
<!--        <div class="row" style="height:40px;">
        ...
        <div class="split row">
            <div class="col-xs-12 col-sm-3" style="text-align: center;">
                <select name="kind" id="" onchange=mbar(this) name="fenlei" size="1" style="height:30px;">
                    <option value="Fishtail">人气推荐</option>
                    <option value="Fishtail">齐地婚纱</option>
                    <option value="Fishtail">鱼尾婚纱</option>
                    <option value="Fishtail">拖地婚纱</option>
                    <option value="Fishtail">蓬蓬裙婚纱</option>
                </select>
            </div>
        </div>
        ...
        <div class="row bottom_40">
            <div class="col-sm-6 col-md-6 div1">
                <div class="row">
                    <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img id="i1" class="pic6 img-responsive"  src="../img/hs_6.png"></a>
                </div>
                <div class="row">
                    <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  id="i2" class="pic6 img-responsive"src="../img/hs_9.png"></a>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 div1">
                <div class="row">
                    <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  id="i3" class="pic6 img-responsive" src="../img/hs_7.png"></a>
                </div>
                <div class="row">
                    <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img   id="i4" class="pic6 img-responsive"src="../img/hs_8.png"></a>
                </div>
                <div class="row">
                    <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img   id="i5" class="pic6 img-responsive"src="../img/hs_10.png"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container bottom_40">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_11.png"></a>
            </div>
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_12.png"> </a>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_13.png"></a>
            </div>
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_14.png"> </a>
            </div>
        </div>
    </div>
    ...
    <div class="container bottom_40">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive" src="../img/hs_17.png"></a>
            </div>
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_18.png"></a>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_19.png"></a>
            </div>
            <div class="col-sm-6 col-md-6 div1">
                <a href="BridalVeil_Detail.jsp?name=蓬蓬裙&imgurl=../img/hsxq_1.png&author=莫言" target="_blank"><img  class="pic6 img-responsive"src="../img/hs_20.png"></a>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function mbar(sobj) {
        ...
        var name =sobj.options[sobj.selectedIndex].innerHTML;
        var docur=docurl+".jsp"+"?name="+name;
        if (docurl != "") {
            open(docur,'_blank');
