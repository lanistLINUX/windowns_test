...
<html>
	...
	<body>
		...
		<div class="cart mt">
			...
			<div class="site">
				<p class=" wrapper clearfix">
					...
					<img class="top" src="../img/temp/cartTop01.png">
					<a href="Accessories.jsp" class="fr">继续购物&gt;</a>
				</p>
			</div>
			<!-----------------table------------------->
		...
		<c:forEach items="${car_wp }" var="wp">
				  <div class="th"> 
				
				
					  <div class="pro clearfix">
						<label class="fl">
							<input type="checkbox" name="test"  value=${wp.wp_id } />
    						<span></span>
						</label>
						<a class="fl" href="#">
							<dl class="clearfix">
								<dt class="fl" ><img style="width: 100px;height: 100px"  src="${wp.wp_url }" ></dt>
								<dd class="fl">
									<p>${wp.wp_name }</p>
									<p>颜色分类:</p>
									<p>${wp.wp_texture }</p>
					...
					<div class="price">￥${wp.wp_price }</div>
					<div class="number">
						<p class="num clearfix">
							<img class="fl sub" src="../img/temp/sub.jpg">
							<span class="fl" name="sum">1</span>
							<img class="fl add" src="../img/temp/add.jpg">
						</p>
					</div>
					<div class="price sAll">￥${wp.wp_price }</div>
					<div class="price"><a class="del" href="../del_CarWp_Servlet?wp_id=${wp.wp_id }"   onclick="return del()" >删除</a></div>  
				...
				<div class="tr clearfix">
					...
					<p class="fr">
						...
						<a href="#" class="count" id="jiesuan" onclick="show()">结算</a>
					</p>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript">
			...
			if(check_val!=""){
				...
				$("#jiesuan").attr("href","../get_AllAddress_Servlet?wp_list="+check_val);
