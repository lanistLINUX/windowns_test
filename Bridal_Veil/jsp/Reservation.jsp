        ...
        <div class="row">
            ...
            <div class="m_char col-xs-12 col-lg-6">
                <div class="row">
                    ...
                    <form action="../order_Servelt" method="post">
                    <div class="ch_in col-xs-12" align="center">
                        <div class="in_pre">姓名:</div>
                        <input class="ch_input" type="text" name="name" id="user" value="${userName }"/>
                    </div>
                    <div class="ch_in col-xs-12" align="center">
                    ...
                    <div class="ch_in col-xs-12" align="center">
                        ...
                        <select class="ch_select" name="style" size=1>
                            <option value="西式婚纱">西式婚纱</option>
                            <option value="中式婚纱">中式婚纱</option>
                    ...
                    <div class="ch_in col-xs-12" align="center">
                        ...
                        <select class="ch_select" name="author" size=1>
                    ...
                    <div class="ch_in2 col-xs-12">	<!--onclick="reserve()"  -->
                        <input class="in_subButton" type="submit" value="提交"  />
