	...
	<body>
		...
		<div class="Bott">
			<div class="wrapper clearfix">
				<div class="zuo fl">
					<h3>
						<a href="#"><img style="width: 100px;height: 100px"  src= "${Person.user_tou }"/></a>
						<p class="clearfix"><span class="fl">${userName }</span><span class="fr">[退出登录]</span></p>
					</h3>
					<div>
						<h4>我的交易</h4>
						<ul>
						...
						<h4>个人中心</h4>
						<ul>
							<li  class="on"><a href="Person.jsp">我的中心</a></li>
							<li><a href="address.jsp">地址管理</a></li>
						</ul>
						<h4>账户管理</h4>
						<ul>
							<li><a href="mygrxx.jsp">个人信息</a></li>
							<li><a href="Chose_Passwd.jsp">修改密码</a></li>
						</ul>
					</div>
				</div>
				<div class="you fl">
					<div class="tx clearfix">
						<div class="fl clearfix">
							<a href="#" class="fl"><img style="border-radius: 300px;width: 100px;height: 100px" src="${Person.user_tou }"/></a>
							<p class="fl"><span>${userName }</span><a href="../admin_GetPersion_Servlet">修改个人信息></a></p>
						</div>
