...
<div class="container">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="port-1 effect-1">
                    ...
                    <div class="text-desc">
                        ...
                        <a href="ChidalVeil_Detail.jsp?name=秀禾服" target="_blank" class="btn">learn more</a>
                    </div>
                </div>
            </div>
            <!--图二-->
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="port-1 effect-1">
                    ...
                    <div class="text-desc">
                        ...
                        <a href="ChidalVeil_Detail.jsp?name=龙凤褂" target="_blank" class="btn">learn more</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="port-1 effect-1">
                    ...
                    <div class="text-desc">
                        ...
                        <a href="ChidalVeil_Detail.jsp?name=小凤仙" target="_blank" class="btn">learn more</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="port-1 effect-1">
                    ...
                    <div class="text-desc img-responsive">
                        ...
                        <a href="ChidalVeil_Detail.jsp?name=旗袍" target="_blank" class="btn">learn more</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="port-1 effect-1">
                    ...
                    <div class="text-desc">
                        ...
                        <a href="ChidalVeil_Detail.jsp?name=改良款礼服" target="_blank" class="btn">learn more</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <a href="ChidalVeil.jsp" target="_blank"><img src="../img/ChidalVeil/41.png" alt="" class="img-responsive img1"></a>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <a href="ChidalVeil.jsp" target="_blank"><img src="../img/ChidalVeil/42.png" alt="" class="img-responsive img1"></a>
            </div>
        </div>
        <div class="row" style="">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <a href="ChidalVeil.jsp" target="_blank"><img src="../img/ChidalVeil/43.png" alt="" class="img-responsive img1"></a>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <a href="ChidalVeil.jsp" target="_blank"><img src="../img/ChidalVeil/44.png" alt="" class="img-responsive img1"></a>
            </div>
        </div>
    </div>
